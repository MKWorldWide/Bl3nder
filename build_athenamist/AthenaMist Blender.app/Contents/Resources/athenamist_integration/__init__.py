...
bl_info = {
    "name": "AthenaMist AI Agent (Built-in)",
    "author": "AthenaMist Team",
    "version": (1, 0, 0),
    "blender": (3, 0, 0),
    "location": "View3D > Sidebar > AthenaMist",
    "description": "Revolutionary AI assistant for Blender (built-in)",
...
class AthenaMistPreferences(bpy.types.AddonPreferences):
    ...
    enable_athenamist: bpy.props.BoolProperty(
        name="Enable AthenaMist AI Agent",
        description="Enable the built-in AthenaMist AI Agent",
        default=False
    )
    ...
    def draw(self, context):
        ...
        layout.prop(self, "enable_athenamist")
        if self.enable_athenamist:
            layout.label(text="AthenaMist is enabled!", icon='CHECKMARK')
        else:
            layout.label(text="AthenaMist is disabled.", icon='CANCEL')
